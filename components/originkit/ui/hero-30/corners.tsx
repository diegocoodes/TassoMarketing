...
export const Corners = ({
  ...
  <>
    <span
      aria-hidden
      className={`pointer-events-none absolute ${size} border-t border-l border-solid border-[var(--color-gold)]`}
      style={{ top: inset, left: inset }}
    />
    <span
      aria-hidden
      className={`pointer-events-none absolute ${size} border-t border-r border-solid border-[var(--color-gold)]`}
      style={{ top: inset, right: inset }}
    />
    <span
      aria-hidden
      className={`pointer-events-none absolute ${size} border-b border-l border-solid border-[var(--color-gold)]`}
      style={{ bottom: inset, left: inset }}
    />
    <span
      aria-hidden
      className={`pointer-events-none absolute ${size} border-r border-b border-solid border-[var(--color-gold)]`}
